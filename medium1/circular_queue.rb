...
# is treated as though it is connected end-to-end in a circle. 
...
# with a circular queue, the object that has been in the queue the longest is discarded 
...
# a circular_queue is linear data structure that follows fifo first in first out principles.   
# If the queue isn't full, enqueue the object to the end of the queue.  if the queue is full, dequeue the 
# oldest(first) object and add the new object to the end of the queue.  
